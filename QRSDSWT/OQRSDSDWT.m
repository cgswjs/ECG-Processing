function [Denozsig1]=OQRSDSDWT(sig1,swd,swa,wavename,ecgdata,NoDs,fs,QRSl,QRSs,QRSe,bpt2,bpt3,bpt4,bpt5,bpt6,bpt7,bpt8,bpt9,gr)
...
[qrs_amp_raw1,qrs_i_raw,ecg_h1]=pan_tompkinR(sig1,fs,gr);%R peak detection
%QRS detection
if QRSl==1%em
    %level 1  
    for i=2:length(qrs_i_raw)
        D1(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
elseif QRSl==2
    %level 1
    for i=2:length(qrs_i_raw)
    ...
    for i=2:length(qrs_i_raw2)
        D2(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
elseif QRSl==3
    %level 1
    for i=2:length(qrs_i_raw)
    ...
    %level 3
    for i=2:length(qrs_i_raw)
        D3(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
elseif QRSl==4
    %level 1
    for i=2:length(qrs_i_raw)
    ...
    %level 4
    for i=2:length(qrs_i_raw)
        D4(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
elseif QRSl==5
     %level 1
    for i=2:length(qrs_i_raw)
    ...
    %level 5
    for i=2:length(qrs_i_raw)
        D5(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
...
elseif QRSl==6
    ...
    %level 6
    for i=2:length(qrs_i_raw)
        D6(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
...
elseif QRSl==7
    ...
    %level 7
    for i=1:length(qrs_i_raw)
        D7(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
elseif QRSl==8
     %level 1
    for i=2:length(qrs_i_raw)
    ...
    %level 8
    for i=1:length(qrs_i_raw)
        D8(qrs_i_raw(i)-QRSs:qrs_i_raw(i)+QRSe)=0;
    end
